...
...
description: Check consultant availability for a time period. Shows who is free and when, or checks
  when a specific person can start. Use when you need to understand capacity before
  committing someone to a role.
...
