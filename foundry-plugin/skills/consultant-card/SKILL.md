...
---
description: "Generate a rich HTML consultant card artifact for a given employee \u2014 matching\
  \ the visual design of the Concierge web app card. Renders inline in the Claude\
  \ artifacts panel."
