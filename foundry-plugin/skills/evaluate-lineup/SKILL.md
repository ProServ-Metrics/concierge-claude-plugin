...
...
description: Run a comprehensive 7-dimension evaluation of a proposed engagement team. Spawns 6
  specialist evaluators in parallel, then synthesizes their structured outputs into
  an Executive Summary + full dimension report.
...
