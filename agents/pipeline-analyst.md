...
...
description: Analyzes the resource allocation impact of a proposed team assignment on the broader
  opportunity pipeline. Identifies conflicts, capacity concerns, and alternative staffing
  options.
...
---
