...
...
description: Find top candidates for a specific role by skills, availability, or other criteria.
  Use when searching for people for a role without running the full staffing workflow.
...
argument-hint: '[skill keywords or role description]'
when_to_use: user asks who is available, who has a skill, find me someone for, who can fill this
  role
...
---
# Find Candidates
